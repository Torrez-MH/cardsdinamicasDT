...
let card = document.getElementById("pastEvents-container");
let eventos = data.events
let fechaEventos = data.currentDate
let pastCard = eventos.filter(fecha => fecha.date < fechaEventos)
...
function filtroCruzado(){
  let filtroCheck = filtro(pastCard)
